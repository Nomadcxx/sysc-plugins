# Vendored from noctalia-dev/official-plugins wallpaper_depth (MIT):
# https://github.com/noctalia-dev/official-plugins/tree/main/wallpaper_depth
# Author: noctalia. Unmodified apart from this header; the sysc-shell port
# runs it as a helper process (see service.go in this plugin).
