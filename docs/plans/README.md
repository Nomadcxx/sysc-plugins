...
| `2026-09-25-faith.md` | plan | The Faith TDD sequence: the shell's `cross` glyph, the reference model and pool, the API client and offline pool text, prayers, wrapping, views, the process wiring, and the integration gate. |
