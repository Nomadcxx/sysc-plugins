...
| `2026-09-25-faith.md` | plan | The Faith TDD sequence: the shell's `cross` and `menu_book` glyphs, the reference model and pool, the API client and offline pool text, prayers, wrapping, views, the process wiring, the integration gate, and a closing bd handover. |
